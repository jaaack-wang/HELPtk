# The following script is originally written by Lynten 
# at: https://github.com/Lynten/stanford-corenlp. 
# The script has been midly modified to ensure people using 
# this Historical English Language Processing Toolkit (HLEPtk)
# do not encounter any trouble due to some bugs in the original corenlp.py file. 
# You can either install the package on your own following instructions given 
# at the related GitHub page (https://github.com/Lynten/stanford-corenlp), or 
# simply use the one included here. 
...
class StanfordCoreNLP:
    def __init__(self, path_or_host, memory='4g', lang='en', timeout=1500, quiet=True,
